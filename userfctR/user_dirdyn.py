...
def user_dirdyn_loop(mbs_data, mbs_dirdyn):
    ...
    mbs_data.set_output(Sensor_BallL.P[3], "BallL_p")  # The vertical position of the ball of the left foot
    mbs_data.set_output(Sensor_BallR.P[3], "BallR_p")  # The vertical position of the ball of the right foot
    mbs_data.set_output(Sensor_HeelL.P[3], "HeelL_p")  # The vertical position of the heel of the left foot
    mbs_data.set_output(Sensor_HeelR.P[3], "HeelR_p")  # The vertical position of the heel of the right foot
    mbs_data.set_output(Sensor_trunk.P[3], "trunk_p")  # The vector position of the trunk
    mbs_data.set_output(Sensor_hip.P[3], "hip_p")  # The vector position of the hip
